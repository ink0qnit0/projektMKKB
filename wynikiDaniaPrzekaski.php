    ...
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#">Dania i przekąski <span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item">
    ...
    try{
        $baza = new PDO('mysql:host='.$host.';dbname='.$db_name.';charset=utf8',$db_user,$db_password,array(
            ...
            if(strlen($wyszukaj) >= $min_wartosc){
                ...
                $zapytanie = $baza -> prepare("SELECT * FROM przepisy WHERE Nazwa LIKE :wyszukaj AND Kategoria = 'Dania' OR Kategoria = 'Przekaski' ");
